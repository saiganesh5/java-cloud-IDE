...
//
// // The GoogleGenAI instance should be created using named parameter { apiKey: process.env.API_KEY }.
// // It's recommended to create a new instance right before making an API call for up-to-date configuration.
//
